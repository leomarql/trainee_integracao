...
class TurtleBot3Control:
    ...
    def move_turtlebot3(self):
        ...
        x = sqrt(pow((self.target_x - self.current_x), 2) + pow((self.target_y - self.current_y), 2))
        print(x)
    ...
    def inicia(self):
        try:
            service = rospy.Service('vel_control', Vel_control, self.alvo_control)
...
if __name__ == '__main__':
    turtlebot3control = TurtleBot3Control()
    turtlebot3control.inicia()