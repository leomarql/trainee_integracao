...
class AStarPlanner:
    ...
    def get_neighbors(self, node,goal_x,goal_y):
        neighbors = []
        x = node.x
        y = node.y
    ...
    def find_path(self, rviz=None):
        ...
        open_list.put((start_node.f_cost(), start_node))######################## era f_cost
        ...
        while open_list:
            ...
            neighbors = self.get_neighbors(current_node,goal_x,goal_y)
            ...
            for neighbor in neighbors:
                ...
                open_list.put((neighbor.f_cost(), neighbor))##########################alterei 11/06 f_cost
